...
class ActionComments extends Action
{
    ...
    protected function EventComments()
    {
        ...
        LS::Make(ModuleViewer::class)->SetHtmlRssAlternate(
            Router::GetPath('rss').'allcomments/',
            LS::Make(ModuleLang::class)->Get('comments_all')
        );
        /**
    ...
    protected function EventShowComment()
    {
        ...
        $iPage = LS::Make(ModuleComment::class)->GetPageCommentByTargetId(
