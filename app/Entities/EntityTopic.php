...
class EntityTopic extends Entity
{
    ...
    public function Init()
    {
        ...
        $this->aValidateRules[] = [
            ...
            'min'        => 2,
            'allowEmpty' => false,
            'label'      => $this->lang->Get('topic_create_title'),
            'on'         => ['topic', 'link', 'photoset']
        ];
        $this->aValidateRules[] = [
            'topic_title',
            'string',
            ...
            'min'        => 2,
            'allowEmpty' => false,
            'label'      => $this->lang->Get('topic_question_create_title'),
            'on'         => ['question']
        ];
        $this->aValidateRules[] = [
            'topic_text_source',
            ...
            'min'        => 2,
            'allowEmpty' => false,
            'label'      => $this->lang->Get('topic_create_text'),
            'on'         => ['topic', 'photoset']
        ];
        $this->aValidateRules[] = [
            'topic_text_source',
            'string',
            'max'        => Config::Get('module.topic.link_max_length'),
            'min'        => 10,
            'allowEmpty' => false,
            'label'      => $this->lang->Get('topic_create_text'),
            'on'         => ['link']
        ...
        $this->aValidateRules[] = [
            'topic_text_source',
            'string',
            'max'        => Config::Get('module.topic.question_max_length'),
            'allowEmpty' => true,
            'label'      => $this->lang->Get('topic_create_text'),
            'on'         => ['question']
        ];
        $this->aValidateRules[] = [
            ...
            'tags',
            'count'      => 15,
            'label'      => $this->lang->Get('topic_create_tags'),
            'allowEmpty' => Config::Get('module.topic.allow_empty_tags'),
            'on'         => ['topic', 'link', 'question', 'photoset']
        ];
        $this->aValidateRules[] = ['blog_id', 'blog_id', 'on' => ['topic', 'link', 'question', 'photoset']];
        $this->aValidateRules[] =
            ['topic_text_source', 'topic_unique', 'on' => ['topic', 'link', 'question', 'photoset']];
        $this->aValidateRules[] = ['topic_type', 'topic_type', 'on' => ['topic', 'link', 'question', 'photoset']];
        $this->aValidateRules[] = [
            'link_url',
            'url',
            'allowEmpty' => false,
            'label'      => $this->lang->Get('topic_link_create_url'),
            'on'         => ['link']
        ];
    }
    ...
    public function ValidateTopicUnique($sValue, $aParams)
    {
        ...
        if ($oTopicEquivalent =
            LS::Make(ModuleTopic::class)->GetTopicUnique($this->getUserId(), $this->getTextHash())
        ) {
    ...
    public function getSubscribeNewComment()
    {
        ...
        return LS::Make(ModuleSubscribe::class)->GetSubscribeByTargetAndMail(
            'topic_new_comment',
            $this->getId(),
    ...
    public function addQuestionAnswer($data)
    {
        ...
        $this->extractExtra();
        $this->aExtra['answers'][] = ['text' => $data, 'count' => 0];
        $this->setExtra($this->aExtra);
    }
