...
namespace App\Modules\Favourite;

use App\Modules\Favourite\Entity\ModuleFavourite_EntityFavourite;
use App\Modules\Favourite\Entity\ModuleFavourite_EntityTag;
use App\Modules\Favourite\Mapper\ModuleFavourite_MapperFavourite;
...
class ModuleFavourite extends Module {
	...
	public function Init() {
		$this->oMapper=Engine::MakeMapper(ModuleFavourite_MapperFavourite::class);
	}
	/**
	...
	public function AddFavourite(ModuleFavourite_EntityFavourite $oFavourite) {
		...
		if (LS::Make(ModuleFavourite::class)->CanAddFavourite($oFavourite, $oUser)){
		...
		if ($bAddNew and $oFavourite->getTags()) {
			...
			if ($aTags=$this->GetTagsTarget($oFavourite->getTargetType(),$oFavourite->getTargetId())) {
				foreach($aTags as $sTag) {
					$oTag = new ModuleFavourite_EntityTag($oFavourite->_getData());
