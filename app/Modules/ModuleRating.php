...
class ModuleRating extends Module
{
     ...
     * @param int                      $iVoteType  0 - при добавлении нового голоса, 1 - при его изменении, 2 - при
     *                                             отмене
     *
     * @return int
     * @throws \Exception
    ...
    public function VoteComment(
        ...
        if ($iVoteType == 0) {
            $notificationTitle =
                $notificationTitle." проголосовал за ваш <a href='".$notificationLink."'>комментарий</a>";
        } elseif ($iVoteType == 1) {
            $notificationTitle =
                $notificationTitle." изменил голос за ваш <a href='".$notificationLink."'>комментарий</a>";
            $rating = $rating / 2;
        } else {
            $notificationTitle =
                $notificationTitle." отменил голос за ваш <a href='".$notificationLink."'>комментарий</a>";
            $rating = 0;
        }
        $notificationText = "";
