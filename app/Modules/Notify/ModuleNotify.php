...
use App\Modules\Notify\Entity\ModuleNotify_EntityTask;
use App\Modules\Notify\Mapper\ModuleNotify_MapperNotify;
...
use Engine\Modules\Mail\ModuleMail;
...
class ModuleNotify extends Module {
	...
	public function Init() {
		...
		$this->oMapper=Engine::MakeMapper(ModuleNotify_MapperNotify::class);
	}
	/**
	...
	public function Send($oUserTo,$sTemplate,$sSubject,$aAssign=array(),$sPluginName=null) {
		...
		if(Config::Get('module.notify.delayed')) {
			$oNotifyTask = new ModuleNotify_EntityTask(
				array(
					'user_mail'      => $sMail,
					'user_login'     => $sName,
					'notify_text'    => $sBody,
