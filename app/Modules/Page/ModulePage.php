...
use App\Modules\Page\Mapper\ModulePage_MapperPage;
use Engine\Config;
use Engine\Engine;
use Engine\LS;
use Engine\Module;
...
class ModulePage extends Module {
	...
	public function Init() {
		$this->oMapper=Engine::MakeMapper(ModulePage_MapperPage::class);
	}
	/**
	 * Добавляет страницу
	 *
	...
	protected function BuildPagesRecursive($aPages,$bBegin=true) {
		...
		foreach ($aPages as $aPage) {
			...
			$aResultPages[] = new ModulePage_EntityPage($aTemp);
