...
use App\Modules\Stream\Entity\ModuleStream_EntityEvent;
use App\Modules\Stream\Mapper\ModuleStream_MapperStream;
...
class ModuleStream extends Module {
	...
	public function Init() {
		$this->oMapper=Engine::MakeMapper(ModuleStream_MapperStream::class);
	}
	/**
	...
	public function Write($iUserId, $sEventType, $iTargetId, $iPublish=1) {
		...
		if ($iPublish) {
			 ...
			 */
			$oEvent = new ModuleStream_EntityEvent();
