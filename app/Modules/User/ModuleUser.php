...
use App\Modules\Auth\AuthException;
use App\Modules\Auth\ModuleAuth;
...
class ModuleUser extends Module
{
    ...
    {
        $this->oMapper = Engine::MakeMapper(ModuleUser_MapperUser::class);
        /**
...
//        echo $oUser->getRank();
    ...
    function CreateSession(ModuleUser_EntityUser $oUser)
    {
        ...
        $oSession = new ModuleUser_EntitySession();
     ...
     */
    public
    function AddFriend(ModuleUser_EntityFriend $oFriend)
    {
        //чистим зависимые кеши
        /** @var ModuleCache $cache */
        $cache = LS::Make(ModuleCache::class);
     ...
     */
    public
    function DeleteFriend(ModuleUser_EntityFriend $oFriend)
    {
        //чистим зависимые кеши
        /** @var ModuleCache $cache */
        $cache = LS::Make(ModuleCache::class);
     ...
     */
    public
    function EraseFriend(ModuleUser_EntityFriend $oFriend)
    {
        //чистим зависимые кеши
        /** @var ModuleCache $cache */
        $cache = LS::Make(ModuleCache::class);
     ...
     */
    public
    function UpdateFriend(ModuleUser_EntityFriend $oFriend)
    {
        //чистим зависимые кеши
        /** @var ModuleCache $cache */
        $cache = LS::Make(ModuleCache::class);
     ...
     */
    public
    function AddInvite(ModuleUser_EntityInvite $oInvite)
    {
     ...
     */
    public
    function UpdateInvite(ModuleUser_EntityInvite $oInvite)
    {
        //чистим зависимые кеши
        /** @var ModuleCache $cache */
        $cache = LS::Make(ModuleCache::class);
    ...
    {
        $oInvite = new ModuleUser_EntityInvite();
     ...
     */
    public
    function GetCountInviteAvailable(ModuleUser_EntityUser $oUserFrom)
    {
        $sDay = 7;
     ...
     */
    public
    function AddReminder(ModuleUser_EntityReminder $oReminder)
    {
     ...
     */
    public
    function UpdateReminder(ModuleUser_EntityReminder $oReminder)
    {
    ...
    function GetUserNotesByUserId($iUserId, $iCurrPage, $iPerPage)
    {
        ...
        foreach ($aResult as $oNote) {
            if (isset($aUsers[$oNote->getTargetUserId()])) {
                ...
                $oNote->setTargetUser(new ModuleUser_EntityUser()); // пустого пользователя во избеания ошибок, т.к. пользователь всегда должен быть
            }
        }
    ...
    {
        $oChangemail = new ModuleUser_EntityChangemail();
