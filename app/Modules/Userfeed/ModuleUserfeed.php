...
namespace App\Modules\Userfeed;

use App\Modules\Blog\ModuleBlog;
use App\Modules\Topic\ModuleTopic;
use App\Modules\User\ModuleUser;
use App\Modules\Userfeed\Mapper\ModuleUserfeed_MapperUserfeed;
use Engine\Config;
use Engine\Engine;
use Engine\LS;
use Engine\Module;
...
class ModuleUserfeed extends Module {
	...
	public function Init() {
		$this->oMapper=Engine::MakeMapper(ModuleUserfeed_MapperUserfeed::class);
	}
	/**
	...
	public function read($iUserId, $iCount = null, $iFromId = null) {
		...
		$aInaccessible = LS::Make(ModuleBlog::class)->GetInaccessibleBlogsByUser(LS::Make(ModuleUser::class)->GetUserById($iUserId));
