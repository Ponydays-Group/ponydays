...
$config['view']['img_max_width'] = 50000;    // максимальная ширина загружаемых изображений в пикселях
$config['view']['img_max_height'] = 50000;    // максимальная высота загружаемых изображений в пикселях
$config['view']['img_max_size_url'] = 500000;    // максимальный размер картинки в kB для загрузки по URL
...
$config['module']['blog']['users_per_page']  = 200;   // Число пользователей блога на страницу
...
$config['module']['user']['time_active'] = 60*60; 	// Число секунд с момента последнего посещения пользователем сайта, в течение которых он считается активным
...
$config['module']['comment']['max_length'] = 150000;
...
$config['module']['userfeed']['count_default'] = 15; // Число топиков в ленте по умолчанию
...
$config['block']['userfeedBlogs'] = array(
	...
	'blocks'  => array(
                    'right' => array(
                        'userfeedUsers'=> array('priority'=>49), 'userfeedBlogs'=> array('priority'=>50), 'blocks/block.ad.tpl'=>array('priority'=>40), 'blocks/block.bquote.tpl'=>array('priority'=>50), 'stream'=>array('priority'=>100),'tags'=>array('priority'=>60),
                   )
                )
);
...
$config['moderator'] = array(1, 4, 6, 14, 15, 19, 20, 21, 22, 23, 24, 25, 27);
...
//	3 — администраторы сайта, модераторы сайта (с учётом ограничений), администраторы блогов
//	4 — администраторы сайта, модераторы сайта (с учётом ограничений), администраторы блогов, модераторы блогов
//	5 — администраторы сайта, модераторы сайта (с учётом ограничений), администраторы блогов, модераторы блогов, автор объекта (если он может видеть объект)
