 ...
 * Настройки HTML вида
 */
$config['view']['skin']        = 'reboot_test';                                                              // шаблон(скин)
$config['view']['name']        = 'Bunker';                   // название сайта
$config['view']['description'] = 'Сайт про пони для брони.'; // seo description
$config['view']['keywords']    = 'mlp, my little pony, pony, brony, video, music, news, chat, млп, пони, мой маленький пони, брони, видео, музыка, новости, чат';      // seo keywords
...
$config['view']['img_max_size_url'] = 50000;    // максимальный размер картинки в kB для загрузки по URL
...
$config['module']['comment']['max_tree'] = 45;           // Максимальная вложенность комментов при отображении
 ...
 */
$config['compress']['css']['merge'] = false;//true;       // указывает на необходимость слияния файлов по указанным блокам.
...
$config['moderator'] = array(1, 2, 4, 6, 14, 15, 19, 20, 21, 22, 23, 24, 25, 27, 28);
