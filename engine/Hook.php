...
abstract class Hook extends LsObject
{
     ...
     * @param int         $iPriority      Приоритет обработчика хука, чем выше число, тем больше приоритет - хук
     *                                    обработчик выполнится раньше остальных
     */
    protected function AddHook($sName, $sCallBack, $sClassNameHook = null, $iPriority = 1)
    {
        ...
        LS::Make(ModuleHook::class)->AddExecHook($sName, $sCallBack, $iPriority, ['sClassName' => $sClassNameHook]);
    }
    ...
    protected function AddDelegateHook($sName, $sCallBack, $sClassNameHook = null, $iPriority = 1)
    {
        ...
        LS::Make(ModuleHook::class)->AddDelegateHook($sName, $sCallBack, $iPriority, ['sClassName' => $sClassNameHook]);
    }
