...
class ModuleValidate extends Module
{
     ...
     * @return bool
     */
    public function Validate($sNameValidator, $mValue, $aParams = [], $oObject = null)
    {
        if (is_null($oObject)) {
            $oObject = $this;
        }
     ...
     * @return mixed
     */
    public function CreateValidator($sName, $oObject, $aFields = null, $aParams = [])
    {
        ...
        $oValidator->on = empty($aOn) ? [] : array_combine($aOn, $aOn);
