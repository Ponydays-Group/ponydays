...
class ModuleValidate_EntityValidatorTags extends ModuleValidate_EntityValidator {
	...
	public function validate($sValue) {
		...
		if (is_array($sValue)) {
			return $this->getMessage($lang->Get('validate_tags_empty',null,false),'msg',array('min'=>$this->min,'max'=>$this->max));
		}
		...
		if ($iCount>$this->count) {
			return $this->getMessage($lang->Get('validate_tags_count_more',null,false),'msg',array('count'=>$this->count));
		} elseif (!$iCount) {
			return $this->getMessage($lang->Get('validate_tags_empty',null,false),'msg',array('min'=>$this->min,'max'=>$this->max));
		}
		/**
