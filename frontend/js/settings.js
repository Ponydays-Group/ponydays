        ...
        markupSet: [
            ...
            },
            {
                ...
                replaceWith: function(m) {
                    const url = prompt(Lang.get("panel_video_promt"));
            ...
            },
            {
                ...
                key: "L",
                replaceWith: function(m) {
                    const url = prompt(Lang.get("panel_url_promt"));
            ...
            },
            {
                ...
                replaceWith: function(m) {
                    const username = prompt(Lang.get("panel_user_promt"));
            ...
            },
            {
                ...
                replaceWith: function(m) {
                    const title = prompt("Спойлер", "Спойлер");
    ...
    return {
        ...
        markupSet: [
            ...
            {separator: "---------------"},
            {
                ...
                replaceWith: function(m) {
                    const i = prompt("Сколько раз бросить дайс");
                    if(!i)
                        return;
                    const d = prompt("Количество граней дайса");
                    if(!d)
                        return;
                    return "[" + i + "d" + d + "]";
                },
...
//     ClassicEditor
//         .create( document.querySelector( '#form_comment_text' ), {
