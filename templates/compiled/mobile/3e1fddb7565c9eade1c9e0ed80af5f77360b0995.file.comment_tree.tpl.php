<?php /* Smarty version Smarty-3.1.8, created on 2015-12-31 10:19:41
         compiled from "/var/www/bunker//templates/skin/mobile/comment_tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13294072695684d70d4b3551-58982305%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3e1fddb7565c9eade1c9e0ed80af5f77360b0995' => 
    array (
      0 => '/var/www/bunker//templates/skin/mobile/comment_tree.tpl',
      1 => 1451470299,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13294072695684d70d4b3551-58982305',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5684d70d5e1c15_10106691',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5684d70d5e1c15_10106691')) {function content_5684d70d5e1c15_10106691($_smarty_tpl) {?><?php if (!is_callable('smarty_function_hook')) include '/var/www/bunker//engine/modules/viewer/plugs/function.hook.php';
?><?php if ($_smarty_tpl->tpl_vars['oUserCurrent']->value){?>
	...
	<section class="toolbar-update" id="update" style="<?php if ($_smarty_tpl->tpl_vars['aPagingCmt']->value&&$_smarty_tpl->tpl_vars['aPagingCmt']->value['iCountPage']>1){?>display: none;<?php }?>">
		<a href="#" class="update-comments" id="update-comments" onclick="ls.comments.load(<?php echo $_smarty_tpl->tpl_vars['iTargetId']->value;?>
...
<div class="comments" id="comments">
        <header class="comments-header clearfix">
                <h3><?php echo $_smarty_tpl->tpl_vars['aLang']->value['comment_number'];?>
 — <span id="count-comments"><?php echo $_smarty_tpl->tpl_vars['iCountComment']->value;?>
</span></h3>
...
?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['cmtlevel']->value>$_smarty_tpl->tpl_vars['oConfig']->value->GetValue('module.comment.mobile.max_tree')){?>
                        <?php $_smarty_tpl->tpl_vars["cmtlevel"] = new Smarty_variable($_smarty_tpl->tpl_vars['oConfig']->value->GetValue('module.comment.mobile.max_tree'), null, 0);?>
                <?php }?>
...
<?php }else{ ?>
        <?php if ($_smarty_tpl->tpl_vars['oUserCurrent']->value){?>
                ...
                <h4 class="reply-header" id="comment_id_0">
                        <a href="#" class="button" onclick="ls.comments.toggleCommentForm(0); return false;"><?php echo $_smarty_tpl->tpl_vars['sNoticeCommentAdd']->value;?>
</a>
                </h4>
