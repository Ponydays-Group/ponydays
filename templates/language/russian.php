...
return array(
	...
	'blog_restoration' => 'Восстановление',
	'blog_restore' => 'Восстановить',
	/**
	 * Меню блогов
	 */
	...
	'blog_create_type_personal' => 'Личный',
	...
	'blog_create_type_personal_notice' => 'Личный - к этому блогу нельзя присоединиться, писать в него может только автор',
	...
	'topic_comment_add_text_error' => 'Текст комментария должен быть от 2 до 100 000 символов и не содержать разного рода каку',
	...
	'registration_login_error' => 'Неверный логин',
	'registration_login_error_length' => 'Неверный логин, допустим от %%min%% до %%max%% символов',
	'registration_login_error_mixed' => 'Неверный логин, нельзя смешивать латинский и кириллический алфавиты',
	'registration_login_error_wrong' => 'Неверный логин, разрешены только буквы (A-Z, a-z или A-Я, а-я), цифры (0-9) и знак подчеркивания (_)',
	'registration_login_error_used' => 'Этот логин уже занят',
	'registration_login_notice' => 'Может состоять только из букв латинского либо кириллического алфавита (A-Z, a-z или А-Я, а-я), цифр (0-9). Знак подчеркивания (_) лучше не использовать. Длина логина не может быть меньше 3 и больше 30 символов.',
	...
	'registration_password_error' => 'Неверный пароль, допустим от 8 символов',
	'registration_password_error_different' => 'Пароли не совпадают',
	'registration_password_notice' => 'Должен содержать не менее 8 символов и не может совпадать с логином. Не используйте простые пароли, будьте разумны.',
	...
	'uploadimg_submit' => 'Вставить',
	'uploadimg_hide' => 'Скрыть',
	...
	'uploadimg_add' => 'Добавить файлы',
	'uploadimg_url' => 'Добавить ссылку',
	'uploadimg_clear' => 'Очистить',
	/**
	 * Уведомления
	 */
	...
	'timezone_list'=> array(
		...
		'2' => '[UTC + 2] Калининград, Афины, Вильнюс, Киев, Рига, Таллин, Центральная Африка',
		'3' => '[UTC + 3] Волгоград, Москва, Санкт-Петербург, Минск',
		'3.5' => '[UTC + 3:30] Тегеран',
		'4' => '[UTC + 4] Самара, Баку, Ереван, Тбилиси',
		'4.5' => '[UTC + 4:30] Кабул',
		...
		'6' => '[UTC + 6] Омск, Алматы, Астана',
		'6.5' => '[UTC + 6:30] Рангун',
		'7' => '[UTC + 7] Бангкок, Новосибирск, Красноярск',
		'8' => '[UTC + 8] Иркутск, Гонконг, Пекин, Сингапур',
	...
	'topic_lock_control' => 'Прикрепить',
	'topic_lock_control_title' => 'Прикрепить к блогу',
	'topic_lock_control_un' => 'Открепление поста от блога означает передачу прав на удаление, перемещение и закрытие комментов автору поста.\nВы уверены?',
	'topic_control_locked' => 'Пост прикреплён к блогу',
	'topic_control_unlocked' => 'Пост откреплён от блога',
	...
	'ignore_user_topics' => 'Игнорировать топики',
    'disignore_user_topics' => 'Перестать игнорировать топики',
    'ignore_user_comments' => 'Игнорировать комментарии',
    'disignore_user_comments' => 'Перестать игнорировать комментарии',
    'ignore_user_talks' => 'Игнорировать ЛС',
    'disignore_user_talks' => 'Перестать игнорировать ЛС',
    
    'ignore_user_ok_topics' => 'Пользователь добавлен в список игнорируемых (топики)!',
    'disignore_user_ok_topics' => 'Пользователь убран из списка игнорируемых (топики)!',
    'ignore_user_ok_comments' => 'Пользователь добавлен в список игнорируемых (комментарии)!',
    'disignore_user_ok_comments' => 'Пользователь убран из списка игнорируемых (комментарии)!',
    'ignore_user_ok_talk' => 'Пользователь добавлен в список игнорируемых (ЛС)!',
    'disignore_user_ok_talk' => 'Пользователь убран из списка игнорируемых (ЛС)!',
    
    'ignore_dissalow_this' => 'Запрещено игнорировать данного пользователя!',
    'ignore_dissalow_own' => 'Нельзя игнорировать себя!',
    
    'forbid_ignore_user' => 'Запретить игнорировать',
    'allow_ignore_user' => 'Разрешить игнорировать',
    
    'allow_ignore_user_ok' => 'Разрешено игнорировать пользователя',
    'forbid_ignore_user_ok' => 'Запрещено игнорировать пользователя',
    'feedbacks' => array(
