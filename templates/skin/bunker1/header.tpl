...
<head>
<script defer src="http://bunker.lunavod.ru/comments.js"></script>
<script src="http://bunker.lunavod.ru/bquote.js"></script>
<script>
...
if(getCookie("SiteStyle") == "Dark") {
        document.write("<link rel='stylesheet' type='text/css' href='http://bunker.lunavod.ru/dark1.css' />")
}
</script>
...
<ul class="nav nav-userbar" style="float: left;">
{if $oUserCurrent}
...
.spoiler_button2 {
    ...
    onclick=$("div[class^='spoiler_body']").style.display = "block">
