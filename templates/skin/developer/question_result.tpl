...
<button type="submit" class="button button-icon" title="{$aLang.topic_question_vote_result_sort}" onclick="return ls.poll.switchResult(this, {$oTopic->getId()});"><i class="fa fa-align-left"></i></button>
