...
<div class="comments" id="comments">
        <header class="comments-header clearfix">
                <h3>{$aLang.comment_number} — <span id="count-comments">{$iCountComment}</span></h3>
        ...
        {foreach from=$aComments item=oComment name=rublist}
                ...
                {if $cmtlevel>$oConfig->GetValue('module.comment.mobile.max_tree')}
                        {assign var="cmtlevel" value=$oConfig->GetValue('module.comment.mobile.max_tree')}
                {/if}
