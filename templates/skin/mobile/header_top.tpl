<nav id="header" class="clearfix">
	...
	<ul class="nav-userbar">
		...
		<li class="update-comments" onclick="ls.comments.load({$oTopic->getId()},'topic'); return false;"><i id="update-comments" class="fa fa-refresh"></i></li>
...
{/if}
<li onclick="ls.toolbar.scroll.goUp()" title="{$aLang.toolbar_scrollup_go}" class="toolbar-topic-prev"><i class="fa fa-chevron-up"></i></li>
