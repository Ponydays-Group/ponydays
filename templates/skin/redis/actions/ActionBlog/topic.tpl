...
{include 
	...
	bEnableCommentsVoteInfo=$E->make(App\Modules\ACL\ModuleACL::class)->CheckSimpleAccessLevel($oConfig->Get('acl.vote_list.comment.ne_enable_level'), $oUserCurrent, $oTopic, 'topic')
	}
