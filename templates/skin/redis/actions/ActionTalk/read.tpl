...
{include
	...
	bEnableCommentsVoteInfo=$E->make(App\Modules\ModuleACL::class)->CheckSimpleAccessLevel(Engine\Config::Get('acl.vote_list.comment.ne_enable_level'), $oUserCurrent, $oTalk, 'talk')
	}
{/if}
