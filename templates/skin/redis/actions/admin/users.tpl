	...
	{else}
		<thead>
			<tr>
				...
				<th class="cell-ip">IP регистрации</th>
				<th class="cell-ip-last">Последний IP</th>
			</tr>
		</thead>
	{/if}
		...
		{if $aUsersList}
			{foreach from=$aUsersList item=oUserList}
				...
				<tr>
					...
					<td class="cell-ip"><strong>{$oUserList->getIpRegister()}</strong></td>
					<td class="cell-ip-last">{if $oSession}{$oSession->getDateLast()}{/if}</td>
				</tr>
			{/foreach}
		{else}
			<tr>
