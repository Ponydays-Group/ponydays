...
{assign var="bCanEdit" value=$E->make(App\Modules\ModuleACL::class)->UserCanEditComment($oUserCurrent, $oComment,1)}
{assign var="bCanDelete" value=$E->make(App\Modules\ModuleACL::class)->UserCanDeleteComment($oUserCurrent, $oComment,1)}
{if $oComment->isBad()}
<section
...
<section
	...
	<ul class="comment-info">
        ...
        {if $oComment->getUserRank()}<li class="author-rank">{$oComment->getUserRank()}</li>{/if}
	...
	<div class="comment-actions-wrapper">
		<ul class="comment-actions">
			...
			<li class="comment-edited" {if $oComment->getEditCount()}style="display: inline-block;"{/if}>(Изменено)</li>
