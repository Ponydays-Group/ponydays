	...
	{assign var="bEnableTopicVoteInfo" value=$E->make(App\Modules\ModuleACL::class)->CheckSimpleAccessLevel($oConfig->get('acl.vote_list.topic.ne_enable_level'), $oUserCurrent, $oTopic, 'topic')}
