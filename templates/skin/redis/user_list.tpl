                ...
                <tr>
                    <td class="cell-name">
                        ...
                        <p class="username word-wrap"><a
                                    href="{$oUserList->getUserWebPath()}">{$oUserList->getLogin()}</a>
                            {if $oUserNote}
                    ...
                    <td class="cell-date">{if $oSession}{date_format date=$oSession->getDateLast() format="d.m.y, H:i"}
                        ...
                        {/if}</td>
                    {if $oUserCurrent}{if $oUserCurrent->isAdministrator() || $oUserCurrent->isGlobalModerator()}
                        <td class="cell-email"><a href="mailto:{$oUserList->getMail()}">{$oUserList->getMail()}</a>
                        </td>{/if}{/if}
                    ...
                    <td class="cell-rating {if $oUserList->getRating()>0}cell-rating-positive{else}cell-rating-negative{/if}">
